...
const Login = props => {
    ...
    return(
      <div className="fixed inset-0 bg-black bg-opacity-50 z-40 flex justify-center items-center">
        <dialog open className="rounded-lg bg-white p-4 max-w-lg mx-auto z-50" id="login_modal">
          <div className="modal-content">
            <form onSubmit={handleLogin}>
              <button type="button" className="btn btn-sm btn-circle absolute right-2 top-2" onClick={props.toggle}>X</button>
              <div class="mb-4">
